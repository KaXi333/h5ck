<template>
  <div class="countDownBox">
    ...
    <div v-if="msTime.show" class="home__banner__countdown">
      <span class="widget__countdown">
        <img src="../../common/images/rc.png">
        {{msTime.day}}
        <span class="widget__countdown__sub" style="margin-right:4px;">日</span>
        <span class="widget__countdown__sub"></span>{{msTime.hour}}
        <span class="widget__countdown__sub" style="margin-right:4px;">时</span>
        <span class="widget__countdown__sub"></span>{{msTime.minutes}}
        <span class="widget__countdown__sub" style="margin-right:4px;">分钟</span>
        <span class="widget__countdown__sub"></span>{{msTime.seconds}}
        <span class="widget__countdown__sub">秒钟</span>
      </span>
    </div>
